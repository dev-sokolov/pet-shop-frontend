    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} className={styles.wrapper}>
                ...
                <input {...register("userPhone", { required: "Phone number is required" })} className={styles.inputStyle} type="tel" placeholder="Phone number" />
                ...
                <div className={styles.btn}>
                    <button type="submit" className={saleStatus === "OK" ? styles.btnActiveStyle : styles.btnStyle}  >{saleStatus === "OK" ? "Request Submitted" : "Get a discount"}</button>
                </div>
            </form>
        </>
    )
